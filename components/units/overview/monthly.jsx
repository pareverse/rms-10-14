		...
		<>
			<Flex direction="column" gap={6}>
				...
				<Flex justify="end" gap={6}>
					<Box w={200}>
						<Input value={`₱ ${Number(data.monthly_rent).toLocaleString(undefined, { maximumFractionDigits: 2 })}`} readOnly />
					</Box>
				</Flex>
			</Flex>
						...
						<ModalBody>
							<Flex direction="column" gap={6}>
								<FormControl isInvalid={errors.monthly_rent}>
									...
									<Input defaultValue={data.monthly_rent} size="lg" {...register('monthly_rent', { required: true })} />
